...
namespace AIGames.Conquest.Arena
{
    ...
    public struct Elo : ISerializable, IXmlSerializable, IFormattable, IComparable, IComparable<Elo>
    {
        ...
        /// <summary>Gets a new Elo based on the other, the result and the k-factor.</summary>
        /// <param name="other">
        /// The Elo of the other.
        /// </param>
        /// <param name="score">
        /// The actual score.
        /// </param>
        ...
        /// </param>
        /// <returns></returns>
        public Elo GetNew(Elo other, double score, double k)
        {
            var div = score - GetZScore(this, other);
            var nw = (double)this + div * k;
            return (Elo)nw;
        }
        ...
        public static bool operator  >(Elo l, Elo r) { return l.m_Value  > r.m_Value; }
